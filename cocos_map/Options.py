...
# =============================================================================
        ...
        if max(freqlims) <= 2/(Video.dt): #Nyquist criterion
            ...
            self.freqlims      = freqlims
            op_print('maximum frequency changed to Nyquist criterion max(freqlims) = {}'.format(max(freqlims)))
        ...
        if minNumPix_from_kk0lims <= minPpOffWaveLength:
            ...
            op_print('minimum number of points per offshore wave length increased to {} according to minimum kk0 = {}'.format(self.minPpOffWaveLength,min(self.kk0lims)))
        self.d0_ini             = d0_ini
        # timestepping
        # ------------
